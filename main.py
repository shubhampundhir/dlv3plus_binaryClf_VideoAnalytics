...
def get_argparser():
    ...
    # Dataset Options
    parser.add_argument("--data_root", type=str, default='/home/shubhamp/Downloads/finaldata_15ktest/data',
    ...
    parser.add_argument("--step_size", type=int, default=1000) #model checkpoint save interval
...
def main():
    ...
    # Initialize wandb
    # wandb.init(project="binary_batchsize128_backbonefreeze", name="loss_visualization", config=vars(opts))
